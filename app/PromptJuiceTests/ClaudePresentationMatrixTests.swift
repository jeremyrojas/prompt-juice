    ...
    func testClaudePresentationMatrix() {
        ...
        let cases: [Case] = [
            ...
            Case(
                ...
                settingsStatus: "Goes live next time you use Claude Code in the terminal",
                setupButtonTitle: nil,
                tooltip: "Estimated from local Claude Code activity · send a message in Claude Code to see exact usage",
                popover: "You're set up — showing a quick estimate for now. Send any message in Claude Code (terminal) and it switches to your exact usage.",
                displayPercent: "~42%",
                headerDetailIncludes: ["Claude ~42%", "Codex 80%", "resets in 2h 30m"],
                headerDetailExcludes: ["Claude 42%"],
                claudeSeverity: .healthy,
            ...
            Case(
                ...
                popover: "Right now it's showing your last exact reading from \(staleTime). It'll refresh when you next use Claude Code in the terminal.",
                displayPercent: "42%",
                headerDetailIncludes: ["Claude 42%", "Codex 80%", "resets in 2h 30m"],
                headerDetailExcludes: ["Claude ~42%"],
                claudeSeverity: .healthy,
            ...
            Case(
                ...
                settingsStatus: "Goes live next time you use Claude Code in the terminal",
                setupButtonTitle: nil,
                tooltip: "You're set up · send a message in Claude Code to see exact usage",
                popover: "You're set up. Open Claude Code in your terminal and send any message — PromptJuice reads your exact usage from the response.",
                displayPercent: "n/a",
