    ...
    func testClaudePresentationMatrix() {
        ...
        let cases: [Case] = [
            ...
            Case(
                ...
                settingsStatus: "Estimate",
                setupButtonTitle: nil,
                tooltip: "Estimated from local Claude Code activity · updates when you use Claude Code in the terminal",
                popover: "Right now it's estimating. It'll go live when you next use Claude Code in the terminal.",
                displayPercent: "~42%",
                headerDetailIncludes: ["Claude ~42%", "Codex 80%", "resets in 2h 30m"],
                headerDetailExcludes: ["Claude 42%"],
                claudeSeverity: .healthy,
