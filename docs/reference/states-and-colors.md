...
| 3 | estimated, bridge current | Estimate · use Claude Code in the terminal + ⓘ | — | ~41% | Estimated from local Claude Code activity · use Claude Code in the terminal to go live | open Settings |
...
| 6 | unavailable, bridge current | Use Claude Code in the terminal to go live + ⓘ | — | Waiting for terminal ghost row, no Set up cue | Bridge installed · open Claude Code in the terminal to go live | open Settings |
